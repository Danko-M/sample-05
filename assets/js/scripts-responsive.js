$(".mobile-menu").click(function() {
    $(".menu ul").toggle("slow"), $(".sidebar-section").toggle(), $(".find-information #carousel-widen").toggle('slow')
}), ! function(t) {
    ...
    return function t(e, n, i) {
        ...
        1: [function(t, e) {
            ...
            function n(t) {
                t = t || {}, this._startOffsetX = 0, this._currentOffsetX = 0, this._opening = !1, this._moved = !1, this._opened = !1, this._preventOpen = !1, this.panel = t.panel, this.menu = t.menu, this.panel.className += " slideout-panel", this.menu.className += " slideout-menu", this._fx = t.fx || "ease", this._duration = parseInt(t.duration, 10) || 300, this._tolerance = parseInt(t.tolerance, 10) || 70, this._padding = parseInt(t.padding, 10) || 256, this._initTouchEvents()
            }
            var i, o = t("decouple"),
                s = !1,
                r = window.document,
                ...
                p = function() {
                    var t = /^(Webkit|Khtml|Moz|ms|O)(?=[A-Z])/,
                        e = r.getElementsByTagName("script")[0].style;
                    for (var n in e)
            ...
            n.prototype.open = function() {
                ...
                return this.isOpen() || this._opening ? (this._setTransition(), this._translateXTo(0), this._opened = !1, setTimeout(function() {
                    a.className = a.className.replace(/ slideout-open/, ""), t.panel.style.transition = t.panel.style["-webkit-transition"] = ""
                }, this._duration + 50), this) : this
            }, n.prototype.toggle = function() {
                return this.isOpen() ? this.close() : this.open()
            }, n.prototype.isOpen = function() {
                return this._opened
            }, n.prototype._translateXTo = function(t) {
                this._currentOffsetX = t, this.panel.style[p + "transform"] = this.panel.style.transform = "translate3d(" + t + "px, 0, 0)"
                ...
                o(r, "scroll", function() {
                ...
                }), r.addEventListener(l.move, function(e) {
                    t._moved && e.preventDefault()
                }), this.panel.addEventListener(l.start, function(e) {
                    t._moved = !1, t._opening = !1, t._startOffsetX = e.touches[0].pageX, t._preventOpen = !t.isOpen() && 0 !== t.menu.clientWidth
                    ...
                    if (!s && !t._preventOpen) {
                        ...
                        if (!(Math.abs(i) > t._padding) && Math.abs(n) > 20) {
                            if (t._opening = !0, t._opened && n > 0 || !t._opened && 0 > n) return;
                            t._moved || -1 !== a.className.search("slideout-open") || (a.className += " slideout-open"), 0 >= n && (i = n + t._padding, t._opening = !1), t.panel.style[p + "transform"] = t.panel.style.transform = "translate3d(" + i + "px, 0, 0)", t._moved = !0
                        }
                    }
                })
            }, e.exports = n
